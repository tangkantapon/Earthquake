...
// class Detectiongraphpage extends StatelessWidget {
//
//   @override
//   Widget build(BuildContext context) => Scaffold(
//     appBar: AppBar(
//       title: Text('Detection graph'),
//     ),
...
class Detectiongraphpage extends StatefulWidget {
  @override
  _DetectiongraphpageState createState() => _DetectiongraphpageState();

}

class _DetectiongraphpageState extends State<Detectiongraphpage> {
